                ...
                <div className="form-block-inner">
                    ...
                    <div id='form-content' className="form-block-content formActiv">
                        <div className="form-block-user-name">
                            ...
                            <div className="forms">
                                <input id='name' onChange={changeName} className="input" placeholder="Ваше имя" required="" type="text"/>
                                <span className="input-border"></span>
                            </div>
                        </div>
                        <div className="form-block-user-number">
                            <div className="form-block-title">Как с Вами связаться?</div>
                            <div className="forms">
                                <input id='number' onChange={changeNumber} className="input" placeholder="e-mail, тел. или TG" required="" type="text"/>
                                <span className="input-border"></span>
                            </div>
                        </div>
                        <button onClick={setForm} id="form-block-btn" className="form-block-btn" disabled={button}>ПОДТВЕРДИТЬ</button>
                    </div>
                    <div id='form-galg' className="form-block-gala none">
                        ...
                        <div id='form-galg-text' className="form-galg-text">Спасибо, с Вами свяжется наш менеджер</div>
                    </div>
                </div>
             </div>
        </div>
