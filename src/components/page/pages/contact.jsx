...
function Contact({languageContent}) {
    ...
    return(
        <div className="conteiner">
            ...
            <div id='about-text-none' className="about-text-none none"> About3</div>
                <div className="Contact-page-title">
                    ...
                    <div className="contact-liks">
                        <a href='https://dribbble.com/pingwing' className="contact-link">
                            <img src={beh} alt="" className="contact-links-icon" />
                        </a>
                        <a href='https://www.instagram.com/pingwing.ru/' className="contact-link">
                            <img src={inst} alt="" className="contact-links-icon" />
                        </a>
                        <a href='https://t.me/pingwingstudio' className="contact-link">
                            <img src={tg} alt="" className="contact-links-icon" />
                        </a>
                        <a href='https://www.tiktok.com/@pingwing.ru' className="contact-link">
            ...
            <img src={cube} alt="" className="contact-cube-one" />
            <img src={cube2} alt="" className="contact-cube-two" />
            <img src={fish} alt="" className="contact-fihe-one" />
            <img src={fish2} alt="" className="contact-fihe-two" />
        </div>
    )
}
